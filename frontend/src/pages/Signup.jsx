...
import { Mail, Lock, User, Phone, Building2, GraduationCap, MapPin, Eye, EyeOff, Loader2, Calendar } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-4 py-12">
      <div className="w-full max-w-2xl">
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-600 to-green-500 rounded-2xl shadow-lg mb-4">
            <MapPin className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Join Campus Navigator</h1>
